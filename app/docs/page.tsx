      ...
      <div className="legal-container">
        ...
        <section>
          ...
          <ol>
            ...
            <li>Your image will be pinned to IPFS</li>
            <li>Your NFT will be minted</li>
          </ol>
          <p className="note">
            Note: The entire process takes 2-3 minutes. Do not close the browser during generation.
          </p>
        </section>

        <section>
          <h2>5. View Your Creation</h2>
          <p>
            Once complete, you can:
          </p>
          <ul>
            <li>Download your looksmaxxed image</li>
            <li>View on IPFS (permanent storage)</li>
        ...
        <section>
          <h2>Understanding the Burn Mechanism</h2>
          <p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Double-check transaction details before approving</li>
